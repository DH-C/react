...
public class CustomerController  {
	...
	public ModelMap batchListProcess(@RequestBody ArrayList<CustomerTO> batchList) {

		try {

			HashMap<String, Object> resultMap = cooperatorSF.batchCustomerListProcess(batchList);
