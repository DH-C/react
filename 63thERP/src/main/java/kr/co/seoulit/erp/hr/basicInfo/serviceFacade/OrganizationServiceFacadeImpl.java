...
import kr.co.seoulit.erp.hr.basicInfo.applicationService.CompanyApplicationService;
import kr.co.seoulit.erp.hr.basicInfo.applicationService.DepartmentApplicationService;
import kr.co.seoulit.erp.hr.basicInfo.applicationService.LogiWorkplaceApplicationService;
...
public class OrganizationServiceFacadeImpl implements OrganizationServiceFacade {
   ...
   public ArrayList<PositionTO> getPositionList() {
      ...
      try {
         System.out.println("=======================OrganizationServiceFacadeImpl   getPositionList메서드실행===========================");
